        ...
        adRef.once('value', function(snapshot) {
            ...
            snapshot.forEach(function(data) {
                ...
                adHtml += '<tr id="' + name + '">\
                            ...
                            <td>' + sponsorName + '</td>\
                            <td>' + clickCount + '</td>\
                            <td><button id="' + name + '_del" type="button" class="btn btn-default btn-sm" href="#" onclick="clickDelete(event)">刪除</button>&nbsp;<button id="' + name + '_mod" type="button" class="btn btn-primary btn-sm" href="#" onclick="clickView(event)">檢視</button></td>\
                            </tr>';
            });
            $("#list").append(adHtml);
        });
    ...
    $('#writeNewPost').on('click', function(event) {
        ...
        if(firebase.database().ref().update(sets)){
            ...
            var htm = '<tr id="' + adId + '">\
                            ...
                            <td>' + adSponsor + '</td>\
                            <td>0</td>\
                            <td><button id="' + adId + '_del" type="button" class="btn btn-default btn-sm" href="#" onclick="clickDelete(event)">刪除</button>&nbsp;<button id="' + adId + '_mod" type="button" class="btn btn-primary btn-sm" href="#" onclick="clickView(event)">檢視</button></td>\
                            </tr>'
            $("#list").append(htm);
        }else{

jQuery(document).ready(function($) {
    ...
    function createPostElement(postKey, userId, userName, userImage, postBody, postTime, postImage, likeCount) {
        ...
        html = html +
            ...
            '<button id="' + postKey + '_comment" class="btn btn-primary" onclick="writeNewComment(event)" type="button"><i class="fa fa-paper-plane fa-fw" id="' + postKey + '_comment" aria-hidden="true" writeNewComment(event)></i>&nbsp;發送</button>' +
            '</span>' +
            '</div></div>' +
            '</li>';
